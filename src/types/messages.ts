...
// Content hash: 628e13e47a63

import { z } from "zod";

/** API schema for a chat message. */
export const messageSchema = z.object({
  actors: z.array(z.unknown()).optional(), // Message actors
  agent: z.string().optional(), // Agent if sent by an agent user
  attachments: z.array(z.unknown()).optional(), // Message attachments
  ...
  metadata: z.unknown().optional(), // Message metadata
  org: z.string().optional(), // Organization
  reactions: z.array(z.unknown()).optional(), // Message reactions
  rendering_mode: z.string().optional(), // Rendering mode hint
  replies: z.array(z.unknown()).optional(), // Inline replies (if loaded)
  ...
  reply_to: z.unknown().optional(), // Parent message object (if loaded)
