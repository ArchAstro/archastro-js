...
export class NotificationPreferenceResource {
   ...
   */
  async list(): Promise<NotificationPreferenceList> {
   ...
   */
  async replace(input: { app_id?: string | undefined; channel: string; enabled: boolean; type: string }): Promise<NotificationPreference> {
