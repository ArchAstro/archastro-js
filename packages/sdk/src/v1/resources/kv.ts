...
export class KvResource {
  ...
  async list(params?: { page?: number; pageSize?: number; user?: string; userSearch?: string; key?: string }): Promise<KeyValueStorageEntryPage> {
    return this.http.request(`/api/v1/kv`, { query: params as Record<string, string | number | boolean | Array<string | number | boolean> | undefined> });
  }
  ...
  async get(key: string, params?: { user?: string }): Promise<KeyValueStorageEntry> {
    return this.http.request(`/api/v1/kv/${key}`, { query: params as Record<string, string | number | boolean | Array<string | number | boolean> | undefined> });
  }
