...
export class TrajectoryResource {
   ...
   */
  async contents(trajectory: string): Promise<{ content: ArrayBuffer; mimeType: string }> {
    return this.http.requestRaw(`/api/v1/trajectories/${trajectory}/contents`);
  }
}
