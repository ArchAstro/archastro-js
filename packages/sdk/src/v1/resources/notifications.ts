...
export class NotificationResource {
  ...
  async list(params?: { status?: string; limit?: number; afterCursor?: string }): Promise<{ after_cursor?: string | undefined; before_cursor?: string | undefined; data: { archived_at?: string | undefined; created_at: string; id: string; read_at?: string | undefined; rendered: Record<string, unknown>; status: string; type: string }[]; has_more: boolean }> {
    return this.http.request(`/api/v1/notifications`, { query: params as Record<string, string | number | boolean | Array<string | number | boolean> | undefined> });
  }
