...
export class AgentResource {
  ...
  async agentHealthActions(agent: string, params?: { source?: string[]; status?: string[]; kind?: string[] }): Promise<HealthActionListResponse> {
    return this.http.request(`/api/v1/agents/${agent}/agent_health_actions`, { query: params as Record<string, string | number | boolean | Array<string | number | boolean> | undefined> });
  }
  ...
  async export(agent: string, params?: { removeIdentity?: boolean }): Promise<AgentExport> {
    return this.http.request(`/api/v1/agents/${agent}/export`, { query: params as Record<string, string | number | boolean | Array<string | number | boolean> | undefined> });
  }
