...
// Content hash: e8ef3fd45f72

import { HttpClient } from "../../runtime/http-client.js";
import type { Agent, AgentComputer, AgentComputerListResponse, AgentCreateResponse, AgentEnvVarMasked, AgentEnvVarMaskedList, AgentExport, AgentHealth, AgentListResponse, AgentRoutine, AgentSchedule, AgentTool, AgentToolListResponse, AgentUpgradeResponse, HealthActionListResponse, Installation, InstallationKindListResponse, InstallationListResponse, WorkingMemoryEntry, WorkingMemoryEntryListResponse } from "../../types/common.js";
import type { Thread } from "../../types/threads.js";
import type { WorkflowWorkItemClaim, WorkflowWorkItemList } from "../../types/workflows.js";
...
export class AgentAgentComputerResource {
   ...
   */
  async create(agent: string, input: { config?: Record<string, unknown> | undefined; lookup_key?: string | undefined; metadata?: Record<string, unknown> | undefined; name: string; provider?: string | undefined; region?: string | undefined }): Promise<AgentComputer> {
...
export class AgentWorkingMemoryResource {
   ...
   */
  async delete(agent: string, entry: string): Promise<void> {
   ...
   */
  async update(agent: string, entry: string, input: { expires_at?: string | undefined; value?: string | undefined }): Promise<WorkingMemoryEntry> {
...
export class AgentWorkItemResource {
   ...
   * @returns Successful response
   */
  async list(agent: string, params?: { execution?: string; limit?: number; afterCursor?: string }): Promise<WorkflowWorkItemList> {
    const query: Record<string, string | number | boolean | Array<string | number | boolean> | undefined> = {};
   ...
   * @returns Successful response
   */
  async claim(agent: string, input: { execution?: string | undefined; lease_owner: string; lease_seconds?: number | undefined; work_item?: string | undefined }): Promise<WorkflowWorkItemClaim> {
...
export class AgentResource {
   ...
   * @param input.source_types - Exact source-type slugs filtering both chunks and documents, e.g. `["knowledge/documents"]` for authored documents or `["thread/messages"]` for conversation memory. Omit or pass an empty array to include all source types.
   * @returns Successful response
   */
  async search(agent: string, input: { max_results?: number | undefined; min_similarity?: number | undefined; mode?: string | undefined; query: string; recency_days?: number | undefined; source_types?: string[] | undefined }): Promise<{ data: ({ content?: string | undefined; content_type?: string | undefined; created_at?: string | undefined; id: string; kind: "chunk"; metadata?: Record<string, unknown> | undefined; raw_content?: Record<string, unknown> | undefined; type?: string | undefined } | { id: string; kind: "document"; metadata?: Record<string, unknown> | undefined; snippet?: string | undefined; title?: string | undefined; total_lines?: number | undefined; total_size?: number | undefined; type?: string | undefined })[] }> {
