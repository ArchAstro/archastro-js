...
export class ArtifactResource {
  ...
  async content(artifact: string, params?: { version?: number }): Promise<{ content: ArrayBuffer; mimeType: string }> {
    return this.http.requestRaw(`/api/v1/artifacts/${artifact}/content`, { query: params as Record<string, string | number | boolean | Array<string | number | boolean> | undefined> });
  }
}
