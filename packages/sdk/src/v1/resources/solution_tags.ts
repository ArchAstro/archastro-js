...
export class SolutionTagResource {
  ...
  async list(params?: { page?: number; pageSize?: number; keys?: string[]; lookupKey?: string; pathPrefix?: string; owners?: string[] }): Promise<SolutionTagListResponse> {
    return this.http.request(`/api/v1/solution_tags`, { query: params as Record<string, string | number | boolean | Array<string | number | boolean> | undefined> });
  }
}
