...
export class SolutionCategoryResource {
  ...
  async list(params?: { page?: number; pageSize?: number; keys?: string[]; parentKeys?: string[]; lookupKey?: string; pathPrefix?: string; owners?: string[] }): Promise<SolutionCategoryListResponse> {
    return this.http.request(`/api/v1/solution_categories`, { query: params as Record<string, string | number | boolean | Array<string | number | boolean> | undefined> });
  }
}
