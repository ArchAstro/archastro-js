...
export class AgentRoutineRunResource {
  ...
  async list(params?: { agent?: string[]; status?: string; limit?: number; beforeCursor?: string; afterCursor?: string }): Promise<AgentRoutineRunListResponse> {
    return this.http.request(`/api/v1/agent_routine_runs`, { query: params as Record<string, string | number | boolean | Array<string | number | boolean> | undefined> });
  }
}
