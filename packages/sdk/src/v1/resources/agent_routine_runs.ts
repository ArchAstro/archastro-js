...
// Content hash: d14abd153b68

import { HttpClient } from "../../runtime/http-client.js";
import type { AgentRoutineRun, AgentRoutineRunListResponse } from "../../types/common.js";
...
export class AgentRoutineRunResource {
   ...
   * @param agentRoutineRun - ID of the agent routine run to stream status updates for.
   * @returns Server-Sent Events stream
   */
  async *stream(agentRoutineRun: string): AsyncIterable<{ event: "run_update"; data: AgentRoutineRun }> {
    yield* this.http.streamSSE(`/api/v1/agent_routine_runs/${agentRoutineRun}/stream`) as AsyncIterable<{ event: "run_update"; data: AgentRoutineRun }>;
  }
}
