...
export class OauthResource {
   ...
   * @param input - Request body.
   * @param input.client - OAuth client ID identifying the application requesting tokens. Required for `"authorization_code"`, device-code, and resource-bound refresh grants.
