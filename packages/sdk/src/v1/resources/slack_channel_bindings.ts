...
export class SlackChannelBindingResource {
  ...
  async list(params?: { integration?: string[]; team?: string[]; agent?: string[]; org?: string[]; page?: number; perPage?: number }): Promise<SlackChannelBindingListResponse> {
    return this.http.request(`/api/v1/slack_channel_bindings`, { query: params as Record<string, string | number | boolean | Array<string | number | boolean> | undefined> });
  }
  ...
  async get(channel: string, params?: { slackTeamId?: string }): Promise<SlackChannelBinding> {
    return this.http.request(`/api/v1/slack_channel_bindings/${channel}`, { query: params as Record<string, string | number | boolean | Array<string | number | boolean> | undefined> });
  }
}
