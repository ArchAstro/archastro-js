...
export class AgentSessionResource {
   ...
   */
  async create(input: { agent: string; instructions: string; max_runs_per_turn?: number | undefined; max_tokens?: number | undefined; max_turns?: number | undefined; metadata?: Record<string, unknown> | undefined; name?: string | undefined; start_idle?: boolean | undefined; team?: string | undefined; thread?: string | undefined; user?: string | undefined }): Promise<AgentSession> {
   ...
   */
  async *stream(agentSession: string): AsyncIterable<{ event: "session_update"; data: AgentSession }> {
    yield* this.http.streamSSE(`/api/v1/agent_sessions/${agentSession}/stream`) as AsyncIterable<{ event: "session_update"; data: AgentSession }>;
  }
}
