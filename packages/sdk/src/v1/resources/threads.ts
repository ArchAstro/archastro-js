...
export class ThreadResource {
   ...
   * @returns Successful response
   */
  async trajectories(thread: string, params?: { beforeCursor?: string; afterCursor?: string; limit?: number; message?: string }): Promise<{ after_cursor?: string | undefined; before_cursor?: string | undefined; data: { agent_message?: string | undefined; created_at?: string | undefined; id: string; org?: string | undefined; sandbox?: string | undefined; thread?: string | undefined; trajectory?: string | undefined; updated_at?: string | undefined; user_message?: string | undefined }[] }> {
    const query: Record<string, string | number | boolean | Array<string | number | boolean> | undefined> = {};
    if (params?.beforeCursor !== undefined) {
      query["before_cursor"] = params?.beforeCursor;
    }
