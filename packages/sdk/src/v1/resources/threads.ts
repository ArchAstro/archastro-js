...
export class ThreadResource {
  ...
  async artifacts(thread: string, params?: { groupKey?: string; groupKeyPrefix?: string }): Promise<{ data: { agent?: string | undefined; content_type?: string | undefined; created_at?: string | undefined; current_version?: string | undefined; description?: string | undefined; file?: string | undefined; file_name?: string | undefined; file_url?: string | undefined; group_key?: string | null | undefined; id: string; image_source?: { file?: string | null | undefined; height?: number | null | undefined; media?: string | null | undefined; mime_type?: string | null | undefined; refresh_url?: string | null | undefined; url?: string | null | undefined; width?: number | null | undefined } | undefined; name?: string | undefined; org?: string | undefined; sandbox?: string | undefined; system?: boolean | undefined; team?: string | undefined; thread?: string | undefined; updated_at?: string | undefined; user?: string | undefined; version?: number | undefined }[] }> {
    ...
    return this.http.request(`/api/v1/threads/${thread}/artifacts`, { query });
  }
   ...
   * @param thread - Thread ID (`thr_...`). The authenticated user must own this thread or belong to its workspace.
   * @param params - Query parameters.
   * @param params.beforeCursor - Opaque cursor from a previous response's `before_cursor` field. Returns the page of results preceding that cursor position.
   * @param params.afterCursor - Opaque cursor from a previous response's `after_cursor` field. Returns the page of results following that cursor position.
   * @param params.limit - Maximum number of trajectories to return per page. Defaults to 20; maximum is 100.
   * @param params.message - Message ID (`msg_...`). When provided, limits results to trajectories associated with this specific message.
   * @returns Successful response
   */
  async trajectories(thread: string, params?: { beforeCursor?: string; afterCursor?: string; limit?: number; message?: string }): Promise<{ after_cursor?: string | null | undefined; before_cursor?: string | null | undefined; data: { agent_message?: string | null | undefined; created_at?: string | undefined; id: string; org?: string | null | undefined; sandbox?: string | null | undefined; thread?: string | undefined; trajectory?: string | undefined; updated_at?: string | undefined; user_message?: string | null | undefined }[] }> {
    const query: Record<string, string | number | boolean | Array<string | number | boolean> | undefined> = {};
    if (params?.beforeCursor !== undefined) {
      query["before_cursor"] = params?.beforeCursor;
    }
    ...
    return this.http.request(`/api/v1/threads/${thread}/trajectories`, { query });
  }
}
