...
export class FileResource {
   ...
   */
  async update(file: string, input: { filename?: string | undefined; provider_metadata?: Record<string, unknown> | undefined; share?: boolean | undefined }): Promise<StorageFile> {
