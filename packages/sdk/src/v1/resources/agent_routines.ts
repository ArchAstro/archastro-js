...
export class AgentRoutineRunResource {
   ...
   */
  async journal(run: string, params?: { limit?: number; afterCursor?: string }): Promise<RunJournalPage> {
...
export class AgentRoutineResource {
   ...
   */
  async invoke(routine: string, input: { delivery?: { message?: string | undefined; thread?: string | undefined; type: "none" | "thread" | "reply" } | undefined; idempotency_key?: string | undefined; message: string; metadata?: Record<string, unknown> | undefined; participants?: Record<string, unknown> | undefined; session_key?: string | undefined; thread_id?: string | undefined; user?: string | undefined }): Promise<AgentRoutineRun> {
