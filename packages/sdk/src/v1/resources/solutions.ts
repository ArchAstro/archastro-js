...
export class SolutionResource {
   ...
   */
  async image(solution: string, params?: { token?: string; v?: string; file?: string }): Promise<{ content: ArrayBuffer; mimeType: string }> {
    const query: Record<string, string | number | boolean | Array<string | number | boolean> | undefined> = {};
   ...
   * @param input.install_inputs - Values applied to parameterized AgentTemplate prose during a root Agent install. Use `{values: {customer_label: "Acme"}}`.
   ...
   */
  async install(solution: string, input: { acl?: { add?: { actions: string[]; principal?: string | undefined; principal_type: string }[] | undefined; grants?: { actions: string[]; principal?: string | undefined; principal_type: string }[] | undefined; remove?: { principal?: string | undefined; principal_type: string }[] | undefined } | undefined; allow_auto_import?: boolean | undefined; details?: { prefills?: { participants?: Record<string, unknown> | undefined; payload?: Record<string, unknown> | undefined } | undefined; type: "automation" } | undefined; install_inputs?: Record<string, unknown> | undefined; lookup_key?: string | undefined; lookup_key_suffix?: string | undefined; name?: string | undefined; org?: string | undefined; target?: string | undefined; team?: string | undefined; template?: string | undefined; user?: string | undefined }): Promise<SolutionInstallResponse> {
   ...
   */
  async reconcileProductKnowledge(solution: string): Promise<ProductKnowledgeReconcileResponse> {
   ...
   */
  async view(solution: string, input: { anonymous?: string | undefined }): Promise<void> {
