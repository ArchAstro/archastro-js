...
export class SolutionResource {
  ...
  async list(params?: { page?: number; pageSize?: number; lookupKey?: string; pathPrefix?: string; owners?: string[] }): Promise<SolutionListResponse> {
    return this.http.request(`/api/v1/solutions`, { query: params as Record<string, string | number | boolean | Array<string | number | boolean> | undefined> });
  }
  ...
  async readme(solution: string, params?: { token?: string; file?: string }): Promise<{ content: ArrayBuffer; mimeType: string }> {
    return this.http.requestRaw(`/api/v1/solutions/${solution}/readme`, { query: params as Record<string, string | number | boolean | Array<string | number | boolean> | undefined> });
  }
