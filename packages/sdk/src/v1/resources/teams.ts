...
// Content hash: f7ab381fb0fa

import { HttpClient } from "../../runtime/http-client.js";
import type { CustomObject } from "../../types/common.js";
import type { Task } from "../../types/tasks.js";
import type { Team, TeamDeleteImpactResponse, TeamInvite, TeamMembership } from "../../types/teams.js";
...
export class TeamInviteResource {
  constructor(private http: HttpClient) {}
   ...
   */
  async create(team: string): Promise<TeamInvite> {
   ...
   * @returns No content
   */
  async delete(team: string, code: string): Promise<void> {
    await this.http.request(`/api/v1/teams/${team}/invite/${code}`, { method: "DELETE" });
  }
}
...
export class TeamTaskResource {
   ...
   * @param params.status - Filter tasks by status. One of `"open"`, `"in_progress"`, `"in_review"`, or `"done"`. Omit to return tasks in all statuses.
   ...
   * @returns Successful response
   */
  async blockerCycles(team: string, params?: { user?: string; org?: string; limit?: number; afterCursor?: string }): Promise<{ after_cursor?: string | undefined; before_cursor?: string | undefined; data: { tasks: { agent?: string | null | undefined; aggregate_version?: number | null | undefined; blocked_by_count?: number | undefined; closed_at?: string | null | undefined; comments_count?: number | undefined; created_at?: string | undefined; created_by_actor?: { alias?: string | null | undefined; id?: string | null | undefined; name?: string | null | undefined; profile_picture?: { file?: string | null | undefined; height?: number | null | undefined; media?: string | null | undefined; mime_type?: string | null | undefined; refresh_url?: string | null | undefined; url?: string | null | undefined; width?: number | null | undefined } | null | undefined } | null | undefined; created_by_agent?: string | null | undefined; created_by_user?: string | null | undefined; current_lease?: { expires_at: string; harness: string; session_name: string } | null | undefined; description?: string | null | undefined; due_date?: string | null | undefined; epic?: string | null | undefined; id: string; is_blocked?: boolean | undefined; links?: Record<string, unknown> | undefined; metadata?: Record<string, unknown> | undefined; name: string; org?: string | null | undefined; owner_actor?: { alias?: string | null | undefined; id?: string | null | undefined; name?: string | null | undefined; profile_picture?: { file?: string | null | undefined; height?: number | null | undefined; media?: string | null | undefined; mime_type?: string | null | undefined; refresh_url?: string | null | undefined; url?: string | null | undefined; width?: number | null | undefined } | null | undefined } | null | undefined; owner_agent?: string | null | undefined; owner_user?: string | null | undefined; parent?: string | null | undefined; priority?: number | undefined; sandbox?: string | null | undefined; source_id?: string | null | undefined; source_scope?: string | null | undefined; source_type?: string | null | undefined; status: string; subtasks_count?: number | undefined; tags?: string[] | undefined; team?: string | null | undefined; thread?: string | null | undefined; updated_at?: string | undefined; user?: string | null | undefined }[] }[]; has_more: boolean }> {
    const query: Record<string, string | number | boolean | Array<string | number | boolean> | undefined> = {};
    if (params?.user !== undefined) {
      query["user"] = params?.user;
    }
   ...
   * @param params.status - Filter results by status. One of `"open"`, `"in_progress"`, `"in_review"`, or `"done"`. Omit to include all statuses.
...
export class TeamResource {
  ...
  readonly invite: TeamInviteResource;
  ...
  constructor(private http: HttpClient) {
    ...
    this.invite = new TeamInviteResource(http);
   ...
   * @param params - Query parameters.
   * @param params.groupKey - Case-sensitive exact group key. Mutually exclusive with group_key_prefix; null keys do not match.
   * @param params.groupKeyPrefix - Nonempty case-sensitive literal prefix (percent, underscore and backslash are literal). Mutually exclusive with group_key.
   * @returns Successful response
   */
  async artifacts(team: string, params?: { groupKey?: string; groupKeyPrefix?: string }): Promise<{ data: { agent?: string | undefined; content_type?: string | undefined; created_at?: string | undefined; current_version?: string | undefined; description?: string | undefined; file?: string | undefined; file_name?: string | undefined; file_url?: string | undefined; group_key?: string | null | undefined; id: string; image_source?: { file?: string | null | undefined; height?: number | null | undefined; media?: string | null | undefined; mime_type?: string | null | undefined; refresh_url?: string | null | undefined; url?: string | null | undefined; width?: number | null | undefined } | undefined; name?: string | undefined; org?: string | undefined; sandbox?: string | undefined; system?: boolean | undefined; team?: string | undefined; thread?: string | undefined; updated_at?: string | undefined; user?: string | undefined; version?: number | undefined }[] }> {
    const query: Record<string, string | number | boolean | Array<string | number | boolean> | undefined> = {};
    ...
    return this.http.request(`/api/v1/teams/${team}/artifacts`, { query });
  }
   ...
   * @param team - Team ID (`team_...`) to inspect.
   * @returns Stored custom-object rows and the existing physical-deletion contract.
   */
  async dependents(team: string): Promise<TeamDeleteImpactResponse> {
    return this.http.request(`/api/v1/teams/${team}/dependents`);
  }
