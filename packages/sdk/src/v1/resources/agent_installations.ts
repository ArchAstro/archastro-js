...
export class AgentInstallationResource {
   ...
   * @param params.agent - Agent IDs (`agi_...`) to filter results by. When omitted, installations for all agents in the app are returned. Multiple values are OR'd.
