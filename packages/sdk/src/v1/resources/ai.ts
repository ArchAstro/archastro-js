...
export class ChatResource {
   ...
   */
  async models(): Promise<{ data: { capabilities: "image" | "search" | "thinking"[]; default: boolean; id: string; input_media_formats: string[]; name: string; output_media_formats: string[] }[] }> {
