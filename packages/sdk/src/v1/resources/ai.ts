...
export class ChatResource {
   ...
   */
  async models(): Promise<{ data: { capabilities: ("image" | "search" | "thinking")[]; context_window?: number | null | undefined; default: boolean; id: string; input_media_formats: string[]; name: string; output_media_formats: string[] }[] }> {
