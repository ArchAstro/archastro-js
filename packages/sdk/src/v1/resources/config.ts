...
export class ConfigResource {
   ...
   */
  async validate(input: { agent?: string | undefined; data?: Record<string, unknown> | undefined; data_encoding?: string | undefined; kind: string; mime_type: string; raw_content: string; team?: string | undefined; user?: string | undefined }): Promise<ValidationResult> {
