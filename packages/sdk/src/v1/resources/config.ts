...
export class ConfigResource {
  ...
  async facets(params?: { app?: string; team?: string; user?: string; org?: string }): Promise<ConfigFacets> {
    return this.http.request(`/api/v1/config/facets`, { query: params as Record<string, string | number | boolean | Array<string | number | boolean> | undefined> });
  }
