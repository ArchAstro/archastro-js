...
export class CustomObjectResource {
   ...
   * @param input.expected_version - Version number the caller expects to be current. If the object's actual current version does not match, the request returns 409 to signal a concurrent modification. Omit to skip optimistic locking and keep the existing OCC merge retry.
