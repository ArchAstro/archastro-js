...
export class LeaseResource {
   ...
   */
  async create(task: string, input: { harness: string; lease_duration_seconds?: number | undefined; lease_id: string; require_ready?: boolean | undefined; session_id: string; session_name: string }): Promise<TaskSessionLease> {
...
export class LinkResource {
   ...
   */
  async create(task: string, input: { external_scope: string; object_id: string; object_type: string }): Promise<Record<string, unknown>> {
