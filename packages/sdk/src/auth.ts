...
export class AuthClient {
   ...
   * @returns No content
   */
  async requestRegisterMagicLink(alias?: string, email?: string, fullName?: string, redirectUri?: string, setOrg?: boolean, timezone?: string): Promise<Record<string, unknown>> {
    const body: Record<string, unknown> = {};
    if (alias !== undefined) body["alias"] = alias;
    if (email !== undefined) body["email"] = email;
    if (fullName !== undefined) body["full_name"] = fullName;
   ...
   * @returns No content
   */
  async requestMagicLink(email?: string, redirectUri?: string, setOrg?: boolean): Promise<Record<string, unknown>> {
    const body: Record<string, unknown> = {};
    if (email !== undefined) body["email"] = email;
    if (redirectUri !== undefined) body["redirect_uri"] = redirectUri;
    if (setOrg !== undefined) body["set_org"] = setOrg;
