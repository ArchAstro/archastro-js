...
export const artifactSchema = z.object({
  ...
  /** Optional nonunique, case-sensitive grouping key, limited to 1024 UTF-8 bytes. Null when unset; belongs to the artifact, not a content version. */
  group_key: z.string().nullable().optional().describe("Optional nonunique, case-sensitive grouping key, limited to 1024 UTF-8 bytes. Null when unset; belongs to the artifact, not a content version."),
  /** Artifact ID (`art_...`). */
  ...
  /** True when the artifact has no user, team, or agent owner. An organization may own a system artifact. */
  system: z.boolean().optional().describe("True when the artifact has no user, team, or agent owner. An organization may own a system artifact."),
  /** ID of the team that owns this artifact (`tea_...`). `null` if not team-scoped. */
