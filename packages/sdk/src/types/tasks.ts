...
export const taskSchema = z.object({
  ...
  /** Key-value map of named URLs or references associated with the task. Returns an empty object when no links have been set. */
  links: z.record(z.custom<{} | null>((value) => value !== undefined)).optional().describe("Key-value map of named URLs or references associated with the task. Returns an empty object when no links have been set."),
  /** Arbitrary key-value map of application-specific data stored alongside the task. Returns an empty object when no metadata has been set. */
  metadata: z.record(z.custom<{} | null>((value) => value !== undefined)).optional().describe("Arbitrary key-value map of application-specific data stored alongside the task. Returns an empty object when no metadata has been set."),
  /** Human-readable title of the task. */
  ...
  /** Current status of the task. One of `"open"`, `"in_progress"`, `"in_review"`, `"paused"`, `"failed"`, `"superseding"`, `"done"`, or `"cancelled"`. */
  status: z.string().describe("Current status of the task. One of `\"open\"`, `\"in_progress\"`, `\"in_review\"`, `\"paused\"`, `\"failed\"`, `\"superseding\"`, `\"done\"`, or `\"cancelled\"`."),
  /** Number of subtasks under this task. Computed on list/show reads; create/update responses may report 0 until the next read. Always 0 for subtasks. */
...
/** Runtime validator for {@link TaskExternalLink}. */
export const taskExternalLinkSchema = z.object({
  /** External container identity. */
  external_scope: z.string().describe("External container identity."),
  /** Object identity within that container. */
  object_id: z.string().describe("Object identity within that container."),
  /** External object kind. */
  object_type: z.string().describe("External object kind."),
}).describe("An indexed external object linked to a task.") satisfies z.ZodType<TaskExternalLink>;
